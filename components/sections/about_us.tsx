    ...
    return (
        <div>
            <div className="flex flex-col justify-center items-center gap-24 pt-24">
                <h2 className={`${fontOlivier.className} text-rose-900 md:text-7xl text-5xl`}>Qui sommes-nous ?</h2>
                <p className='text-3xl font-bold text-neutral-500 text-center  md:w-2/3'>La Maison des Part&apos;Âges Louis-Girerd, centre social du Plessis-Robinson, offre des services et activités pour tous, renforçant le lien social.</p>
            </div>
