const FormContact = () => {
    return (
        <form action="" className="flex flex-col justify-between items-center gap-8">
            ...
            <textarea name="content" placeholder="Sujet" required className="h-28 border-2 border-gray-300 w-full p-2 px-4"></textarea>
